...
项目的下一阶段是把通用教练扩展成“专属回复 Skill 生成器”：用户先提供与特定对象的经授权聊天记录，系统分别学习对象的互动模式、用户本人的通用语气，以及用户面对这个对象时特有的称呼和亲密程度，再生成完全隔离的本地子 Skill。
...
多人使用时，每个人拥有独立的人物档案、发送者别名、关系语气和子 Skill，例如：
